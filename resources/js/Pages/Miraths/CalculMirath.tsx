    ...
    <div className="max-w-xl mx-auto p-4 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <select name="hal" value={formData.hal} onChange={handleChange} className="w-full border p-2 rounded">
        ...
        {[
          ...
          ['albanat', "Filles"],
          ['alom', "Mère"],
          ['alab_om', "Père de la mère"],
          ['azawj', "Époux"],
          ['azawjat', "Épouses"],
          ['akhowat_achaqiq', "Sœurs germaines"],
          ['akhowat_l2ab', "Sœurs paternelles"],
          ['akhowat_lom', "Sœurs maternelles"]
        ].map(([key, label]) => (
          <div key={key}>
