...
export default function GatelHeritier() {
    ...
    const handleSubmit = () => {
        ...
        for (const [key, value] of Object.entries(formValues)) {
            ...
            const newKey = `${key}_gatel`;

            if (typeof originalValue === "number") {
                const gatelValue = typeof value === "number" ? value : 0;
                updated[newKey as keyof MirathInput] = Math.min(gatelValue, originalValue);
        ...
        router.visit("/suivant");
    };

    return (
        <GuestLayout>
            <div className="p-6 max-w-3xl mx-auto bg-white shadow rounded-lg min-h-[300px]">
                <h1 className="text-2xl font-bold mb-4 text-center">هل يوجد وريث قاتل؟</h1>
