...
const ListeExamen: React.FC<Props> = ({ examens, isAdmin }) => {
    ...
    سيتم تصحيح الأسئلة تلقائيا واعطائك درجتك بعد اختيار إجاباتك والضغط على زر "النتيجة"،
    هذه الأسئلة موضوعة بعناية لتغطى أسس حساب المواريث و تقسيم الميراث،
    و قياس مدى إستيعابك لعلم المواريث، ومعظمها ألغاز وليست مجرد أسئلة مباشرة،
    مستوى الأسئله فى هذا الإختبار فوق المتوسط.
</p>
